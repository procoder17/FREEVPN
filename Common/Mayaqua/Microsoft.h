...
#define	VLAN_ADAPTER_NAME			"TAP-Windows Adapter V9"
#define	VLAN_ADAPTER_NAME_OLD		"TAP-Windows Adapter V9"

// The name of the device driver of the virtual LAN card for Win32 (full name)
#define	VLAN_ADAPTER_NAME_TAG		"TAP-Windows Adapter V9"
#define	VLAN_ADAPTER_NAME_TAG_OLD	"TAP-Windows Adapter V8"
