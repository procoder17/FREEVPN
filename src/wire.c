                   ...
                   const n2n_common_t * common )
{
    ...
    encode_uint8( base, idx, common->id );
                   ...
                   size_t * idx )
{
    ...
    decode_uint8( &(out->id), base, rem, idx );
                           ...
                           const n2n_REGISTER_SUPER_t * reg )
{
    ...
    retval += encode_uint32(base, idx, reg->edgeTapIp);
    ...
    if(reg->auth.toksize > 0)
        retval += encode_buf( base, idx, reg->auth.token, reg->auth.toksize ); /* No auth data */
                           ...
                           size_t * idx )
{
    ...
    retval += decode_uint32(&(reg->edgeTapIp), base, rem, idx);
